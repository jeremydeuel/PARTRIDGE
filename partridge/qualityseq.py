...
class QualitySeq:
    ...
    def has_once(self, search) -> bool:
        return self._sequence.count(str(search))==1

    def find(self, search) -> int:
        return self._sequence.find(str(search))
    def count(self, search) -> int:
        return self._sequence.count(str(search))
